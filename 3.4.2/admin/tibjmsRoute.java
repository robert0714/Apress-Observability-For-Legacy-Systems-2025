...
public class tibjmsRoute
{
    ...
    void usage()
    {
        ...
        System.err.println(" -routeName <server name>  - routed EMS server name, default is \"E4JMS-SERVER-RT\"");
        System.err.println(" -routeURL  <server URL>   - routed EMS server URL, default is \"tcp://localhost:7223\"");
        System.exit(0);
    }
