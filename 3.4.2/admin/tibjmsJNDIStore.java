 ...
 */
  ...
  *
  * This program looks up administered objects from the TIBCO EMS server
  ...
  * (the TIBCO EMS server must be running for this to work).  On the other
...
public class tibjmsJNDIStore
{
    ...
    void usage()
    {
        ...
        System.err.println(" -server    <server URL>   - EMS server URL for new topic or queue connection");
