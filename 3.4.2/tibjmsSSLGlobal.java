...
public class tibjmsSSLGlobal
{
    ...
    public tibjmsSSLGlobal(String[] args)
    {
        ...
        System.err.println("Global TLS parameters sample.");
        ...
        try
        {
            ...
            if (ssl_identity != null)
            {
                ...
                com.tibco.tibjms.TibjmsSSL.setIdentity(ssl_identity,ssl_private_key,ssl_password.toCharArray());
            }
