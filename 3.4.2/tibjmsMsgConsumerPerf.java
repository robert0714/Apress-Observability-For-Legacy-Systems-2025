/* 
 * Copyright (c) 2003-2023 Cloud Software Group, Inc. 
 * All Rights Reserved. 
 * 
 */
    ...
    implements Runnable, com.tibco.tibjms.TibjmsMulticastExceptionListener
{
    ...
    {
        System.err.println();
        System.err.println("Usage: java tibjmsMsgConsumerPerf [options] [tls options]");
        System.err.println();
        ...
        System.err.println("    -help-ssl                   - Print help on TLS parameters.");
        System.exit(0);
    }
