 ...
 * EMS clients.  It demonstrates TLS-based client/server communications.
 *
 * This sample establishes a TLS connection, publishes and
 ...
 *
 * This sample can also demonstrate full use of TLS with the mutual
 ...
 * command line below the client-side TLS trace is being enabled,
...
public class tibjmsSSL
{
    ...
    public tibjmsSSL(String[] args)
    {
        ...
        try
        {
            ...
            if (ssl_expected_hostname != null)
                environment.put(com.tibco.tibjms.TibjmsSSL.EXPECTED_HOST_NAME, ssl_expected_hostname);
            ...
            if (ssl_identity != null)
            {
                ...
                if (ssl_private_key != null)
                   environment.put(com.tibco.tibjms.TibjmsSSL.PRIVATE_KEY, ssl_private_key);
            }
        }
        catch (Exception e)
        {
    ...
    void usage()
    {
        ...
        System.err.println("");
        System.err.println("  TLS options:");
        System.err.println("");
        ...
        System.err.println(" -ssl_expected_hostname  <host-name>     - name expected in the server certificate");
