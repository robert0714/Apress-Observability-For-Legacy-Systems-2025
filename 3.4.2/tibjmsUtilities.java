 ...
 *
 * This file also contains an SSLParams helper class to enable
 * a TLS connection to a TIBCO Enterprise Message Service server.
 *
 */
...
public class tibjmsUtilities
{
    ...
    public static void sslUsage()
    {
        ...
        System.err.println(" -ssl_vendor_trace                     - trace TLS handshake and related");
        ...
        System.err.println(" -ssl_no_verify_host                   - do not verify host certificate.");
        System.err.println("                                         (this is disabled by default)");
        System.err.println(" -ssl_no_verify_hostname               - do not verify certificate name.");
        System.err.println("                                         (this is disabled by default)");
        ...
        implements com.tibco.tibjms.TibjmsSSLHostNameVerifier
    {
        ...
        boolean         ssl_no_verify_host          = false;
        boolean         ssl_no_verify_hostname      = false;
        ...
        public void init() throws JMSSecurityException
        {
            ...
            if (ssl_no_verify_host)
                com.tibco.tibjms.TibjmsSSL.setVerifyHost(false);

            if (ssl_no_verify_hostname)
