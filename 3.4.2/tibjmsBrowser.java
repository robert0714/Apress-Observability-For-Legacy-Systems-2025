...
/*
 * This sample demonstrates the use of the Jakarta Messaging QueueBrowser.
 *
 ...
 * the QueueBrowser class returns false, the Jakarta Messaging application
...
public class tibjmsBrowser
{
    ...
    void usage()
    {
        ...
        System.err.println("  -help-ssl               - help on tls parameters\n");
        System.exit(0);
    }
