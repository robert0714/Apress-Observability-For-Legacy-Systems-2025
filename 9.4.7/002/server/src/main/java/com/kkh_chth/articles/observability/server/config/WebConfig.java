package com.kkh_chth.articles.observability.server.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.kkh_chth.articles.observability.server.service.ArticleClient;
...
public class WebConfig {
    ...
    @Bean
    ArticleClient postClient(WebClient webClient) {
